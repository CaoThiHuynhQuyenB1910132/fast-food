        ...
        <div id="rev_slider_1" class="rev_slide fullwidthabanner" data-version="5.4.5" style="display:none">
            <ul>
                ...
                <li data-transition="fade">
                    ...
                    <img src="client/assets/images/bg-slide-01.jpg" alt="IMG-BG" class="rev-slidebg">
                    ...
                    <p class="tp-caption tp-resizeme layer3"
                       ...
                       data-paddingright="[15, 15, 35, 15]" data-paddingbottom="[0, 0, 0, 0]"
                       data-paddingleft="[15, 15, 35, 15]" data-basealign="slide" data-responsive_offset="on">
    ...
    <div class="container">
        ...
        <div class="wrap-pic-max-w flex-c-t flex-w p-t-255 item-welcome-parent">
            ...
            <div class="item-welcome one">
                <div class="item-welcome-pic pos-relative">
                    <div class="wrap-pic-max-w flex-c-m item-welcome-pic-dark trans-04">
                        <img src="client/assets/images/icons/icon1.png" alt="IMG">
                    </div>
                    <div class="wrap-pic-max-w flex-c-m s-full ab-t-l item-welcome-pic-light trans-04">
                        <img src="client/assets/images/icons/icon1.1.png" alt="IMG">
                    </div>
                </div>
            ...
            <div class="item-welcome two">
                <div class="item-welcome-pic pos-relative">
                    <div class="wrap-pic-max-w flex-c-m item-welcome-pic-dark trans-04">
                        <img src="client/assets/images/icons/icon2.png" alt="IMG">
                    </div>
                    <div class="wrap-pic-max-w flex-c-m s-full ab-t-l item-welcome-pic-light trans-04">
...
<div class="sec-item flex-w">
        ...
        <div class="hov-img1 pos-relative">
            ...
            <a href="shop-product-grid.html" class="s-full ab-t-l flex-col-c-m bg11 p-all-15 hov1-parent">
                <div class="wrap-pic-max-w">
                    <img src="client/assets/images/icons/symbol-03.png" alt="IMG">
                </div>
    ...
    <div class="of-hidden size-w-2 respon2">
        <div class="hov-img1 pos-relative">
            <img src="client/assets/images/bg-item-02.jpg" alt="IMG">
            <a href="shop-product-grid.html" class="s-full ab-t-l flex-col-c-m bg11 p-all-15 hov1-parent">
                <div class="wrap-pic-max-w">
                    <img src="client/assets/images/icons/symbol-04.png" alt="IMG">
                </div>
                <span class="txt-l-102 cl0 txt-center p-t-30 p-b-13">
                        fruit
                    </span>
    ...
    <div class="of-hidden size-w-2 respon2">
        <div class="hov-img1 pos-relative">
            <img src="client/assets/images/bg-item-03.jpg" alt="IMG">
            <a href="shop-product-grid.html" class="s-full ab-t-l flex-col-c-m bg11 p-all-15 hov1-parent">
                <div class="wrap-pic-max-w">
                    <img src="client/assets/images/icons/symbol-05.png" alt="IMG">
                </div>
                <span class="txt-l-102 cl0 txt-center p-t-30 p-b-13">
                        fruit juic
                    </span>
    ...
    <div class="of-hidden size-w-2 respon2">
        <div class="hov-img1 pos-relative">
            <img src="client/assets/images/bg-item-04.jpg" alt="IMG">
            <a href="shop-product-grid.html" class="s-full ab-t-l flex-col-c-m bg11 p-all-15 hov1-parent">
                <div class="wrap-pic-max-w">
                    <img src="client/assets/images/icons/symbol-06.png" alt="IMG">
                </div>
                <span class="txt-l-102 cl0 txt-center p-t-30 p-b-13">
                        dried
                    </span>
