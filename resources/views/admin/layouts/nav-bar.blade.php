<div class="header">
    <div class="header-left">
        <a href="{{ route('dashboard') }}" class="logo"> <img src="admin/assets/img/hotel_logo.png" width="50" height="70" alt="logo"> <span class="logoclass">KING FOOD</span> </a>
        <a href="{{ route('dashboard') }}" class="logo logo-small"> <img src="admin/assets/img/hotel_logo.png" alt="Logo" width="30" height="30"> </a>
    </div>
    ...
    <ul class="nav user-menu">
        ...
        <li class="nav-item dropdown has-arrow">
            <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown"> <span class="user-img"><img class="rounded-circle" src="admin/assets/img/profiles/avatar-01.jpg" width="31" alt="Soeng Souy"></span> </a>
